...
async def schemas_send_schema(request: web.BaseRequest):
    ...
    if transaction_id:
        ...
        if transaction_record.state == "endorse":
            ...
            schema_name = transaction_record.messages_attach[0]["data"]["json"]["operation"]["data"]["schema_name"]
            schema_version = transaction_record.messages_attach[0]["data"]["json"]["operation"]["data"]["schema_version"]
            attributes = transaction_record.messages_attach[0]["data"]["json"]["operation"]["data"]["attributes"]
